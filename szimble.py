...
class Player():
    ...
    def set_enemy_pegs_location(self, player_id,pegs_location):
        print ("Set enemy pegs location: %s %s" % (player_id, pegs_location))
    ...
    def move_peg_to_game(self,peg_id):
        ...
        if self.slots[self.slot_enter] == None:
            ...
            self.slots_owner_id[self.slot_enter] = self.name
    ...
    def move_peg_to_goal(self,peg_id,target_slot):
        ...
        if self.slots[target_slot] == None:
            ...
            self.slots_owner_id[target_slot] = self.name
    ...
    def play(self):
        ...
        for id in range(0,4):
            ...
            if self.dice == 6 \
                ...
                print ("%s peg %s enter game [%s]" % (self.id, id,rule_score["E%s" % id]))
            ...
            if target_slot < self.slot_goal1 and \
                ...
                if self.slots[target_slot] > 9: # Enemy peg ids are over 9
                    ...
                    print ("%s peg %s eat enemy peg from %s [%s]" % (self.id,id,target_slot, rule_score["X%s" % id]))
            ...
            if self.pegs_location[id] < self.slot_goal1 \
                ...
                print ("%s peg %s move to goal slot %s [%s]" % (self.id,id, target_slot,rule_score["G%s" % id]))
